    ...
    <div>
          ...
          <ol role="list" className="flex items-center space-x-4">
            ...
            <li>
              <div className="flex items-center">
                ...
                <a href="#" aria-current="page" className="ml-4 text-sm font-medium text-white hover:text-gray-700">
                  Back End Developer
                </a>
              </div>
            </li>
      ...
      <div className="mt-2 md:flex md:items-center md:justify-between">
        ...
        <div className="mt-4 flex flex-shrink-0 md:mt-0 md:ml-4">
          ...
          <button
            type="button"
            className="ml-3 inline-flex items-center rounded-md bg-bluego-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-bluego-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-bluego-600"
          >
            Publish
          </button>
        </div>
