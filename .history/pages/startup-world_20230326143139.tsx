    ...
    {/* Page Content */}
      ...
      <div className="my-6 mx-auto grid max-w-2xl grid-cols-1 items-start gap-y-16 gap-x-8 sm:gap-y-24 lg:mx-0 lg:max-w-none lg:grid-cols-2">
        <div className="border-cyan-300 border-4 min-h-max">
         <img src="/Users/matthewmertz/Downloads/sc-app-main/public/DALL·E 2022-12-02 21.23.37 - a pastel painting of a large room whose blue walls are inscribed with complex symbols and there is a person standing in the middle of the room.png"></img>
        </div>
        ...
        <div className="mx-auto grid max-w-7xl grid-cols-1 gap-x-8 gap-y-12 px-6 py-6 sm:gap-y-16 lg:grid-cols-2 lg:px-8">
            ...
            <div className="mt-4 flex flex-col justify-between gap-6 sm:mt-8 sm:flex-row-reverse sm:gap-8 lg:mt-4 lg:flex-col">
                ...
                <a
                    ...
                    className="text-sm font-semibold leading-6 text-cyan-300"
            ...
            <div className="-my-12 divide-y divide-gray-900/10">
                ...
                <article key={post.id} className="py-12">
                    ...
                    <time dateTime={post.datetime} className="block text-sm leading-6 text-white">
                        {post.date}
                    </time>
                    ...
                    <p className="mt-4 text-sm leading-6 text-white">{post.description}</p>
                    </div>
