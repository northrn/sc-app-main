    ...
    {/* Page Content */}
      ...
      <div className="my-6 mx-auto grid max-w-2xl grid-cols-1 items-start gap-y-16 gap-x-8 sm:gap-y-24 lg:mx-0 lg:max-w-none lg:grid-cols-2">
        <div className="border-cyan-300 border-4 min-h-max">
         <img src="public/DALL·E 2022-12-02 21.23.37 - a pastel painting of a large room whose blue walls are inscribed with complex symbols and there is a person standing in the middle of the room.png"></img>
        </div>
