  ...
  return (
    <div className="px-6 max-w-7xl">
      ...
      <div className="my-6 md:flex md:items-center md:justify-between">
        <div className=" border-cyan-300 border-4 min-h-max min-w-full"></div>
        <p className="py-2 font-sans text-white text-justify">Donec sollicitudin nec neque vel suscipit. Donec elit neque, porta sed leo nec, accumsan porta leo. Suspendisse imperdiet erat a ante ornare, quis lacinia eros lobortis. Vivamus dignissim malesuada vulputate. Mauris quis sapien eget lacus venenatis bibendum. Integer nec massa gravida, bibendum enim vitae, commodo elit. Praesent vitae laoreet lacus. Nulla viverra tincidunt ornare. Maecenas nec dolor fringilla neque malesuada mollis a at magna. Cras augue nibh, pharetra ac augue non, interdum tristique nisi. Aliquam tincidunt porttitor euismod. Mauris a blandit metus. Donec mattis facilisis neque at luctus.</p>
      </div>
    </div>
  )
}
